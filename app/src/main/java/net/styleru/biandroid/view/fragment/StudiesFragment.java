...
import net.styleru.biandroid.view.adapter.tab.StudiesAdapter;

/**
 * Created by Tetawex on 20.08.2016.
 */
public class StudiesFragment extends TabbedFragment
{
    @Override
    public void onCreate(Bundle savedInstanceState)
    {
        super.onCreate(savedInstanceState);
        titles[0]=getText(R.string.tab_courses);
        titles[1]=getText(R.string.tab_mentors);
    ...
    {
        adapter =  new StudiesAdapter(getFragmentManager(),titles, tabsNumber);
